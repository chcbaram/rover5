...
EXT_LB_PRINTF_DEF int Lb_printf( char *fmt, ... );                                            
EXT_LB_PRINTF_DEF int Lb_sprintf( char *pStr, char *fmt, ... );
EXT_LB_PRINTF_DEF int Lb_vsprintf( char *pStr, char *fmt, Lb_va_list args );
